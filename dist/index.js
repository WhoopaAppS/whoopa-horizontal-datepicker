...
var index = React__default.memo(function ReactHorizontalDatePicker(_ref) {
  ...
  var _verticalList = function _verticalList() {
    ...
    var _loop = function _loop(i) {
      ...
      _verticalListItems.push( /*#__PURE__*/React__default.createElement(reactWaypoint.Waypoint, {
        key: i,
        horizontal: true,
        onPositionChange: function onPositionChange(pos) {
          return _date == 1 ? _handlePosition(pos, dateFns.addDays(_startDay, i)) : '';
        }
      }, /*#__PURE__*/React__default.createElement("div", {
        className: "wrapper"
      }, dateFns.format(dateFns.addDays(_startDay, i), _dateFormat) == 1 ? /*#__PURE__*/React__default.createElement("div", {
        className: "scroll-head"
      }, dateFns.format(dateFns.addDays(_startDay, i), 'MMM')) : /*#__PURE__*/React__default.createElement("div", {
        className: "blank-space-div"
      }), /*#__PURE__*/React__default.createElement("div", {
        className: "datepicker-date-day-Item wrapper " + applyStyles(dateFns.addDays(_startDay, i)),
        onClick: function onClick() {
          return onDateClick(dateFns.addDays(_startDay, i));
        }
      }, /*#__PURE__*/React__default.createElement("div", {
        className: "datepicker-day-label "
      }, _day), /*#__PURE__*/React__default.createElement("div", {
  ...
  var nextScroll = function nextScroll() {
    enableScroll ? document.getElementById('container').scrollLeft += scrollWidth : setCurrentWeek(dateFns.addWeeks(currentWeek, 1));
  };

  var prevScroll = function prevScroll() {
    enableScroll ? document.getElementById('container').scrollLeft -= scrollWidth : setCurrentWeek(dateFns.subWeeks(currentWeek, 1));
  };
  ...
  }, dateFns.format(selectedDate, 'dd MMM yyy')), /*#__PURE__*/React__default.createElement("div", {
    className: "datepicker"
  }, /*#__PURE__*/React__default.createElement("div", {
    className: "wrapper"
  }, /*#__PURE__*/React__default.createElement("div", {
    className: "scroll-head"
  }, dateFns.format(headingDate, 'MMM')), /*#__PURE__*/React__default.createElement("div", {
    className: "button-previous"
  }, ' ', /*#__PURE__*/React__default.createElement("button", {
    className: "datepicker-button-previous",
    onClick: prevScroll
  }, "\u2794"))), _verticalList(), /*#__PURE__*/React__default.createElement("div", {
    className: "wrapper"
  }, /*#__PURE__*/React__default.createElement("div", {
    className: "blank-space-div"
  }), /*#__PURE__*/React__default.createElement("div", {
